function writeV2Tables(groups, analyses, r1Results, r2Results, modelPieces, ...
...
fprintf(fileID, ['Group,MediumID,RawLength,R1CandidateCount,R1Status,' ...
    'R2CandidateCount,R2Status,SelectedForVisualization\n']);
selectedR1 = false; selectedR2 = false; selectedUnresolved = false;
for groupIndex = 1:3
    for mediumID = 1:analyses{groupIndex}.Records
        r1 = r1Results{groupIndex}{mediumID}; r2 = r2Results{groupIndex}{mediumID};
        selected = false;
        ...
        fprintf(fileID, '%d,A%d,%.15g,%d,%s,%d,%s,%d\n', groupIndex, mediumID, ...
            analyses{groupIndex}.SegmentLength(mediumID), r1.CandidateCount, ...
            r1.Status, r2.CandidateCount, r2.Status, selected);
    end
end
fclose(fileID);
